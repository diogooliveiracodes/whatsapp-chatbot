...
class UpdateUnitSettingsRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'whatsapp_api_base_url.url' => __('validation.url', ['attribute' => __('company-settings.whatsapp_api_base_url')]),
            'whatsapp_api_base_url.max' => __('validation.max.string', ['attribute' => __('company-settings.whatsapp_api_base_url'), 'max' => 255]),
            'whatsapp_api_token.string' => __('validation.string', ['attribute' => __('company-settings.whatsapp_api_token')]),
            'whatsapp_api_token.max' => __('validation.max.string', ['attribute' => __('company-settings.whatsapp_api_token'), 'max' => 255]),
            'whatsapp_webhook_secret.string' => __('validation.string', ['attribute' => __('company-settings.whatsapp_webhook_secret')]),
            'whatsapp_webhook_secret.max' => __('validation.max.string', ['attribute' => __('company-settings.whatsapp_webhook_secret'), 'max' => 255]),
