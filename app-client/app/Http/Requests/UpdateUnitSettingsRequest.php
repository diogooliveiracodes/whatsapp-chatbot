...
class UpdateUnitSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'monday_end' => ['nullable', 'date_format:H:i:s'],
            'monday' => ['boolean'],
            'tuesday_start' => ['nullable', 'date_format:H:i:s'],
            'tuesday_end' => ['nullable', 'date_format:H:i:s'],
            'tuesday' => ['boolean'],
            'wednesday_start' => ['nullable', 'date_format:H:i:s'],
            'wednesday_end' => ['nullable', 'date_format:H:i:s'],
            'wednesday' => ['boolean'],
            'thursday_start' => ['nullable', 'date_format:H:i:s'],
            'thursday_end' => ['nullable', 'date_format:H:i:s'],
            'thursday' => ['boolean'],
            'friday_start' => ['nullable', 'date_format:H:i:s'],
            'friday_end' => ['nullable', 'date_format:H:i:s'],
            'friday' => ['boolean'],
            'saturday_start' => ['nullable', 'date_format:H:i:s'],
            'saturday_end' => ['nullable', 'date_format:H:i:s'],
            'saturday' => ['boolean'],
            'use_ai_chatbot' => ['boolean'],
            'default_language' => ['nullable', 'string', 'max:5'],
            'timezone' => ['nullable', 'string', 'max:50'],
