                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                            ...
                            <div>
                                <label for="user_role_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                            ...
                            <div class="mb-4">
                                <label class="flex items-center">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           {{ old('create_new_company') ? 'checked' : '' }}
                            ...
                            <div id="new_company_fields" class="hidden space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="company_document_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            {{ __('CNPJ/CPF') }}
                                        </label>
                                        <input type="text"
                                               id="company_document_number"
                                               name="company_document_number"
                                               value="{{ old('company_document_number') }}"
                                               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                ...
                                <div>
                                    <label for="company_document_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        {{ __('Tipo de Documento') }}
                                    </label>
                                    <select id="company_document_type"
                                            name="company_document_type"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                        <option value="">{{ __('Selecione o tipo') }}</option>
                                        <option value="1" {{ old('company_document_type') == '1' ? 'selected' : '' }}>{{ __('CPF') }}</option>
                                        <option value="2" {{ old('company_document_type') == '2' ? 'selected' : '' }}>{{ __('CNPJ') }}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                            ...
                            <div id="new_unit_fields" class="hidden">
                                <label for="unit_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
