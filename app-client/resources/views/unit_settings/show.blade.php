<x-app-layout>
    <x-global.header>
        <div class="flex items-center space-x-3">
            <span>{{ __('unitSettings.title') }}</span>
        </div>
    </x-global.header>
                ...
                <div class="p-6 space-y-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="bg-gray-700/50 rounded-lg p-4">
                                <div class="flex items-center space-x-2 mb-2">
                                    ...
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.name') }}</label>
                                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-700/50 rounded-lg p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.street') }}</label>
                                    <p class="text-white mt-1">{{ $unitSettings->street ?? '-' }}</p>
                                </div>
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.number') }}</label>
                                    <p class="text-white mt-1">{{ $unitSettings->number ?? '-' }}</p>
                                </div>
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.complement') }}</label>
                                    <p class="text-white mt-1">{{ $unitSettings->complement ?? '-' }}</p>
                                </div>
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.neighborhood') }}</label>
                                    <p class="text-white mt-1">{{ $unitSettings->neighborhood ?? '-' }}</p>
                                </div>
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.city') }}</label>
                                    <p class="text-white mt-1">{{ $unitSettings->city ?? '-' }}</p>
                                </div>
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.state') }}</label>
                                    <p class="text-white mt-1">{{ $unitSettings->state ?? '-' }}</p>
                                </div>
                                <div class="sm:col-span-2 lg:col-span-1">
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.zipcode') }}</label>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="bg-gray-700/50 rounded-lg p-4">
                                <label
                                    class="text-sm font-medium text-gray-300">{{ __('unitSettings.whatsapp_webhook_url') }}</label>
                                <p class="text-white mt-1 break-all">{{ $unitSettings->whatsapp_webhook_url ?? '-' }}
                                </p>
                            </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center space-x-2">
                            ...
                            <h3 class="text-lg font-medium text-white">{{ __('unitSettings.working_hours_section') }}
                            </h3>
                        </div>
                        ...
                        <div class="bg-gray-700/50 rounded-lg p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        class="text-sm font-medium text-gray-300">{{ __('unitSettings.appointment_duration_minutes') }}</label>
                                    <p class="text-white mt-1">
                                        {{ $unitSettings->appointment_duration_minutes ?? '-' }}
                                        {{ __('unitSettings.minutes') }}</p>
                                </div>

                                <div class="sm:col-span-2">
                                    <label
                                        class="text-sm font-medium text-gray-300 mb-4 block">{{ __('unitSettings.working_days') }}</label>
                                    <div class="space-y-3">
                                        @php
                                            $days = [
                                        ...
                                        @if (
                                            !$unitSettings->sunday &&
                                                !$unitSettings->monday &&
                                                !$unitSettings->tuesday &&
                                                !$unitSettings->wednesday &&
                                                !$unitSettings->thursday &&
                                                !$unitSettings->friday &&
                                                !$unitSettings->saturday)
