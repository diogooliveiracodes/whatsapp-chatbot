                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div class="space-y-3 order-1 md:order-1">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <img id="unit-image-preview" src="" alt="" class="hidden h-16 w-16 rounded-full object-cover ring-1 ring-gray-300 dark:ring-gray-700" />
                                        <div class="flex-1 space-y-2">
                                            <input id="unit_image" type="file" accept="image/*" class="sr-only" />
                                            <label id="select-image-label" for="unit_image" class="inline-flex w-full sm:w-auto items-center justify-center gap-2 px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-500 focus:bg-green-700 active:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150 cursor-pointer">
                                            ...
                                            <button type="button" id="remove-image-btn" class="hidden inline-flex w-full sm:w-auto items-center justify-center gap-2 px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none">
