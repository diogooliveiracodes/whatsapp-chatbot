                ...
                <div class="p-6 bg-gray-800 border-b border-gray-700">
                    <form method="POST" action="{{ route('schedules.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="schedule_date" type="date" name="schedule_date" class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 [color-scheme:light] dark:[color-scheme:dark]" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="start_time" type="time" name="start_time" class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 [color-scheme:light] dark:[color-scheme:dark]" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="end_time" type="time" name="end_time" class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 [color-scheme:light] dark:[color-scheme:dark]" required />
                        </div>
